...
听同事说，当时时间比较急，对`vuecli3`不太熟悉，就选了基于`vuecli2`进行快速开发。因为有**6**个系统，页面非常多，所以在底层代码的上没有太多的时间进行优化。在我参与进来之后，我收到了一些同事的反馈和还没有解决的问题，比如首屏加载慢，路由设计存在问题，刷新页面菜单无法高亮等等。跟开发的小伙伴和领导沟通一番之后，他们决定让我去负责解决当前的这些问题，所以当时压力也是有点大的。我想了下，既然要升级，那就把我之前研究出来的成果都一并用上，然后逐步解决。我重新起了一个副本，从0️⃣搭建环境，开始了这段升级旅程👊
...
经过努力，100多次的commit，终于完成了系统优化和代码迁移。最后，这篇文章比较长，感谢您能读到这里，如果文中存在什么不足之处，或者有值得改进的地方，欢迎指出，Chat at anytime!
